...
C   Common name:      CH4O-2014
C
C   References: E. Gonzalez-Lavado, J.C. Corchado and J. Espinosa-Garcia
C                     J.Chem. Phys., Vol. 140, p. 064310, 2014.  
C
C   Notes:
C
...
c
       call ipbend(vip)
c
c  calculate van der Waals potential (new)
c
       call vander(evdw)
c
