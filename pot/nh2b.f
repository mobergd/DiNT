...
! ONLY FOR N2H
! INTERACTION PES FIT TO CC QCISD(T)/CBS(AT,AQ)
...
c        v2=v2+0.666297194   ! zero of E at min of CH4
      endif
...
c HERE
      ...
      elseif (m2.eq.26) then  ! N2-
        if     (m1.eq.1) then !    H
           aa=5.8812219611194188   !N2H
           bb=0.33727301858577230
           cc=6.6170842616046635
           rrc=2.7494735557115391
          aa=(10.d0**aa)
          cutoff=.true.
        elseif (m1.eq.2) then !    C
        else
