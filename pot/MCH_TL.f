...
C
C   Notes:  This PEF is a modification of the MXH PEF.  The coupling has
...
c ********************************************************************
      ...
      subroutine prepot
        ...
        if (g_myrank .eq. 0) then
          write(6,*)'PREPOT called for MCH (TL)'
          write(6,*)
        endif
