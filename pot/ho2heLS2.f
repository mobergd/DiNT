...
***************************************************
      ...
      dimension coef(100),basis(100)
       ...
       ncoef=40
       coef(    1) =    -0.464757998764909974198640000000D+00
       coef(    2) =     0.538942544409489201484580000000D+02
       coef(    3) =     0.652369869894362273043950000000D+04
       coef(    4) =    -0.834006367983523872680960000000D+06
       coef(    5) =    -0.930546848197179497219620000000D+05
       coef(    6) =     0.559062488552359677851200000000D+07
       coef(    7) =     0.141651764407755788415670000000D+08
       coef(    8) =    -0.130960754009762242436410000000D+09
       coef(    9) =     0.126665514944389867782590000000D+10
       coef(   10) =    -0.445426048154711151123050000000D+10
       coef(   11) =    -0.133551461626341819055600000000D+03
       coef(   12) =     0.579615182808444806141780000000D+05
       coef(   13) =    -0.258321383100420003756880000000D+07
       coef(   14) =     0.435766305849508270621300000000D+08
       coef(   15) =    -0.869217003001766628585760000000D+06
       coef(   16) =     0.318832173185541108250620000000D+08
       coef(   17) =    -0.834427743450622677803040000000D+09
       coef(   18) =     0.867147304526925086975100000000D+09
       coef(   19) =    -0.125238445295380249023440000000D+11
       coef(   20) =     0.699377056196376190185550000000D+11
       coef(   21) =    -0.114920624099322922120340000000D+05
       coef(   22) =     0.181003890398600953631100000000D+06
       coef(   23) =     0.154371663787761647254230000000D+08
       coef(   24) =    -0.524897171944757223129270000000D+09
       coef(   25) =    -0.120616921126364730298520000000D+08
       coef(   26) =     0.438904431814877986907960000000D+08
       coef(   27) =     0.139223232866024742126460000000D+11
       coef(   28) =    -0.830921943602408027648930000000D+10
       coef(   29) =     0.255918997567857666015620000000D+11
       coef(   30) =    -0.324728577908249267578120000000D+12
       coef(   31) =     0.611603627191489649703730000000D+05
       coef(   32) =     0.241261272369973734021190000000D+07
       coef(   33) =    -0.277840401652745753526690000000D+08
       coef(   34) =     0.105637575705000460147860000000D+10
       coef(   35) =    -0.209888622180819392204280000000D+09
       coef(   36) =     0.806421553286840724945070000000D+10
       coef(   37) =    -0.726923697337541961669920000000D+11
       coef(   38) =    -0.776736022605715026855470000000D+11
       coef(   39) =     0.102537465731236645507810000000D+13
       coef(   40) =    -0.237816712272046923828120000000D+13

       coef(    1) =    -0.562611190091877877428320000000D+00
       coef(    2) =     0.183575928795167442331150000000D+01
       coef(    3) =     0.209229617741687397938220000000D+05
       coef(    4) =    -0.117325504546364583075050000000D+07
       coef(    5) =    -0.707251033742605795850980000000D+05
       coef(    6) =     0.320258377974820043891670000000D+07
       coef(    7) =     0.511357253318274170160290000000D+08
       coef(    8) =    -0.905308730740959644317630000000D+08
       coef(    9) =     0.383429681432454466819760000000D+09
       coef(   10) =    -0.141496815572794866561890000000D+10
       coef(   11) =     0.861095564563635775812140000000D+02
       coef(   12) =    -0.566662184688228662707840000000D+05
       coef(   13) =     0.750059799875783501192930000000D+06
       coef(   14) =     0.212419417851993925869460000000D+08
       coef(   15) =     0.420362613539539463818070000000D+07
       coef(   16) =    -0.192083855681970357894900000000D+09
       coef(   17) =     0.185497761117293715476990000000D+09
       coef(   18) =     0.279482470780695962905880000000D+10
       coef(   19) =    -0.247977309126192245483400000000D+11
       coef(   20) =     0.840460533267185058593750000000D+11
       coef(   21) =    -0.260432067081322384183300000000D+04
       coef(   22) =     0.243062970532601838931440000000D+07
       coef(   23) =    -0.652310911211301460862160000000D+08
       coef(   24) =     0.538947624965441226959230000000D+08
       coef(   25) =    -0.150935581207371234893800000000D+09
       coef(   26) =     0.698490004863877677917480000000D+10
       coef(   27) =    -0.270012063462429885864260000000D+11
       coef(   28) =    -0.804364623474482116699220000000D+11
       coef(   29) =     0.774096663327155761718750000000D+12
       coef(   30) =    -0.217038569947691552734380000000D+13
       coef(   31) =    -0.346289809069637907668950000000D+06
       coef(   32) =     0.205908972805955484509470000000D+08
       coef(   33) =    -0.246704353809078335762020000000D+08
       coef(   34) =     0.787697825625734329223630000000D+08
       coef(   35) =    -0.122421287928506374359130000000D+09
       coef(   36) =    -0.108447963710124855041500000000D+11
       coef(   37) =     0.657152728810255737304690000000D+11
       coef(   38) =     0.195563447341763732910160000000D+12
       coef(   39) =    -0.218969864119722119140620000000D+13
       coef(   40) =     0.645355940838639062500000000000D+13
