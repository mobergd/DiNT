...
C     Apply expression for triplets as functions of singlets
      ...
      trippi = (trippix + trippiy)/2.d0
       ...
       print *,"sing3(1,1)",sing3(1,1)*autoev
       print *,"sing3(2,2)",sing3(2,2)*autoev
       print *,"sing3(3,3)",sing3(3,3)*autoev

       print *,"ss",singsig*autoev
       print *,"sp",singpi*autoev
       print *,"ts",tripsig*autoev
       print *,"tp",trippi*autoev
     ...
     &  ( 3.d0*c2*(c1+1.d0) - (2.d0*c1 - 1.d0)*(4.d0*c2 - 2.d0) )
        ...
        print *,"ajsigma",ajsigma*autoev
        print *,"ajpi",ajpi*autoev

        trip3(2,2)= sing3(2,2) - 2.d0*ajpi
        trip3a = sing3(1,1) - 2.d0*ajsigma

        print *,"trip3(2,2)",trip3(2,2)*autoev
        print *,"trip3a",trip3a*autoev

        print *,"trippiy",trippiy*autoev
        print *,"trippix",trippix*autoev
        print *,"singpiy",singpiy*autoev
        print *,"singpix",singpix*autoev
...
c          for trip3(1,1) and trip3(3,3)
     ...
     &  (trippiy - trippix)/(singpiy - singpix)
        ...
        print *,"sing3b(3,3)",sing3b(3,3)*autoev
        print *,"ech3",ech3*autoev
     ...
     &  ( 3.d0*c2*(c1+1.d0) - (2.d0*c1 - 1.d0)*(4.d0*c2 - 2.d0) )
        ...
        print *,"trip3(1,1)",trip3(1,1)*autoev
        print *,"trip3(3,3)",trip3(3,3)*autoev
        print *,"trip3b",trip3b*autoev
...
C     Calculate Cartesian gradients of triplet states
     ...
     &    (trippiy - trippix)/(singpiy - singpix) -
     &    (sing3(3,3)-sing3(2,2))*
     &    (trippiy - trippix)/(singpiy - singpix)**2* +
     &    (gsingpiyth*gth(i,j) + gsingpiyphi*gphi(i,j) -
     &     gsingpixth*gth(i,j) - gsingpixphi*gphi(i,j)) +
     &    (sing3(3,3)-sing3(2,2))*
...
c      enddo
      ...
      do i=1,3
       do j=1,nat
        gpemd(i,j,1,1) = gsing3(i,j,1,1)
        gpemd(i,j,2,2) = gsing3(i,j,2,2)
        gpemd(i,j,3,3) = gsing3(i,j,3,3)
        gpemd(i,j,4,4) = 0.d0
        gpemd(i,j,5,5) = 0.d0
        gpemd(i,j,6,6) = 0.d0
       enddo
