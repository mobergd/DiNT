...
c      SUBROUTINE pot(Xcart,U11,U22,U12,V1,V2,
      SUBROUTINE nh3(Xcart,U11,U22,U12,V1,V2,
     1           gU11,gU22,gU12,
     2           gV1,gV2)
C*******************************************************************

C   System:                        NH3
C   Functional form:               2x2 fit to diabats, with adiabats 
...
C
C References:  1) Nangia, S.; Truhlar, D.G. J. Chem. Phys. 2006, 124, 124309
C              2) Li, Z.H.; Valaro, R., Truhlar, D.G. Theor. Chem. Acc.,
C                 submitted in 2006 (to Fernando Bernardi Memorial Issue), 
C                 to be published in 2007.
C
C  Units:
C       energies    - hartrees
C       coordinates - bohrs
...
c      call rarray(4,coord,12,rr,grr,6)
c AJ
      call rarray2(4,coord,12,rr,grr,6)
...
C--------------------------------------------
c      subroutine rarray(natoms,x,mx,r,dr,mr)
c AJ
      subroutine rarray2(natoms,x,mx,r,dr,mr)
