...
C     Now calculate gradients of c1 and c2
     ...
     &  7.d0*gtripsig(i,j) + 6.d0*gtrippi(i,j))*
     &  (5.d0*(singsig - tripsig)) -
     &  (singsig + 2.d0*singpi - 7.d0*tripsig + 6.d0*trippi)*    
     &  (5.d0*(gsingsig(i,j) - gtripsig(i,j))))/
...
C     Calculate Cartesian gradients of triplet states
     ...
     &  (trippiy - trippix)/(singpiy - singpix)
        ...
        gsing3bis(i,j,3,3) = gsing3(i,j,2,2) + ((gsing3(i,j,3,3) - 
     &     gsing3(i,j,2,2))*
     &  (trippiy - trippix) + (sing3(3,3) - sing3(2,2))*
     &  (gtrippiyth*gth(i,j) + gtrippiyphi*gphi(i,j)) -
     &  (gtrippixth*gth(i,j) + gtrippixphi*gphi(i,j))*
     &  (singpiy - singpix) -
     &  (sing3(2,2) + (sing3(3,3)-sing3(2,2))*(trippiy - trippix))*
